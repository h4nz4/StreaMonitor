...
# When True (default), bots use cloudscraper unless the site sets use_cloudscraper = False
USE_CLOUDSCRAPER = env.bool("STRMNTR_USE_CLOUDSCRAPER", True)
...
# Enable TS capture to prevent sync/freezing issues
# Especially useful for Chaturbate's llhls separated audio/video format
CAPTURE_TS = env.bool("STRMNTR_CAPTURE_TS", False)
